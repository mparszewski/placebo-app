...
public interface PatientRepository extends JpaRepository<Patient, Integer> {
    ...
    List<Patient> findByTrial_IdAndPlaceboGroup(int trialId, Integer group);

    List<Patient> findByTrial_IdAndPlaceboGroupAndPhase(int id, Integer group, Integer phase);
